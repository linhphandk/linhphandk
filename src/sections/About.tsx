...
const About = forwardRef<HTMLElement>((_, ref) => (
  <main ref={ref} className="flex justify-center items-center flex-col h-full lg:flex-row">
    <div className="flex justify-center items-center lg:items-start flex-col h-full basis-1/2 max-w-xl">
      <div className="flex justify-center items-start flex-col max-w-lg">
        <h1 className="text-white text-4xl md:text-6xl mb-4 lg:mb-6" style={{ color: "#D4AFB9" }}>About me</h1>
        <p className="text-white text-xl lg:text-xl leading-normal align-center">
